...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => {
  ...
  // Check if there's a DialogDescription inside the children
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        {...props}
      >
        {/* Add unique ID to DialogDescription child if it exists */}
        {React.Children.map(children, child => {
          if (React.isValidElement(child) && child.type?.displayName === 'DialogDescription') {
